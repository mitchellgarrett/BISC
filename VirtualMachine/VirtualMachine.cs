...
namespace FTG.Studios.BISC {
    ...
    public class VirtualMachine {
        ...
        bool LLI(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.LLI) || arg0 >= Specification.NUM_REGISTERS) return false;
            UInt16 imm;
        ...
        bool LUI(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.LUI) || arg0 >= Specification.NUM_REGISTERS) return false;
            UInt16 imm;
            if (BitConverter.IsLittleEndian) imm = BitConverter.ToUInt16(new byte[] { arg2, arg1 }, 0);
            else imm = BitConverter.ToUInt16(new byte[] { arg1, arg2 }, 0);
        ...
        bool MOV(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.MOV) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 != 0) return false;
        ...
        bool ADD(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.ADD) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool SUB(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.SUB) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool MUL(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.MUL) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool DIV(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.DIV) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool MOD(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.MOD) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool NOT(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.NEG) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 != 0) return false;
        ...
        bool INV(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.INV) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 != 0) return false;
        ...
        bool AND(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.AND) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool OR(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.OR) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool XOR(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.XOR) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool BSL(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.BSL) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool BSR(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.BSR) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool JMP(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.JMP) || arg0 >= Specification.NUM_REGISTERS || arg1 != 0 || arg2 != 0) return false;
        ...
        bool JZ(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.JZ) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 != 0) return false;
        ...
        bool JNZ(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.JNZ) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 != 0) return false;
        ...
        bool JE(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.JE) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool JNE(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.JNE) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool JGT(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.JGT) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool JLT(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.JLT) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool JGE(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.JGE) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
        ...
        bool JLE(byte opcode, byte arg0, byte arg1, byte arg2) {
            if (opcode != ((byte)Opcode.JLE) || arg0 >= Specification.NUM_REGISTERS || arg1 >= Specification.NUM_REGISTERS || arg2 >= Specification.NUM_REGISTERS) return false;
