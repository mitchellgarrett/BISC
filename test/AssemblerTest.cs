...
namespace FTG.Studios.BISC.Test {
	...
	public class AssemblerTest {
		...
		public void AssembleInstruction() {
			...
			byte[] actual = Assembler.Assemble(file_name, "nop").AssembleBinary();
		...
		public void Pseduo_LDI_To_LLI_LUI() {
			...
			byte[] actual = Assembler.Assemble(file_name, $"ldi {register}, {immediate}").AssembleBinary();
		...
		public void Pseudo_LRA_To_LLI_LUI() {
			...
			UInt32 immediate = 0xbabecafe;
			byte[] immediate_bytes = immediate.DisassembleUInt32();
			byte[] actual = Assembler.Assemble(file_name, $"lra {register}, {immediate}").AssembleBinary();
		...
		public void Pseudo_CALL_Immediate_To_LDI_Immediate_Call_Register() {
			UInt32 immediate = 0xbabecafe;
			byte[] immediate_bytes = immediate.DisassembleUInt32();
			byte[] actual = Assembler.Assemble(file_name, $"call {immediate}").AssembleBinary();
